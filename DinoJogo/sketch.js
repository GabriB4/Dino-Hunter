...
function preload(){
  ...
  carnEsq = loadImage("spino.png");
  carnDir = loadImage("dime.png");
  carnCima = loadImage("tupa.png");
  carnBaixo = loadImage("dilo.png");


  //Carrega imagens dos dinossauros herbivoros.
  herbEsq = loadImage("stego.png");
  herbDir = loadImage("pachy.png");
  herbCima = loadImage("ptero.png");
  herbBaixo = loadImage("trike.png");
  ...
  playBaixo = loadImage("cacadorBaixo.png");
  playCima = loadImage("cacadorCima.png");
  playEsq = loadImage("cacadorEsq.png");
  playDir = loadImage("cacadorDir.png");


  //Carrega os fundos de tela.
  bg = loadImage("fundo1.png");
